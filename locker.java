...
public class locker {
	...
	static final String projectFilesPath = "F:\\project\\filehandling\\abc"; 
	...
	{ 
		...
		System.out.println("\t================================="); 
		System.out.println("\tDesigned by Ayushman Sisodia"); 
	...
	public static void createFiles1() throws IOException 
	{ 
		try 
		{ 
			Scanner obj = new Scanner(System.in); 
